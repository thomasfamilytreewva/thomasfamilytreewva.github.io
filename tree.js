//TREE.js is a library for creating and drawing properly displayed 
//family trees on the HTML canvas element.
//This is a work in progress.
//Authors: Andy MacDonald
//14 Dec 2018 Uploaded to 000Webhost.com
//--------------------------------------------------------------------------------------------------------
var TREE = (function () {
    "use strict";
    var uID = 0,
        ...
        draw: function (context, tree) {
            var config = {
                ...
                drawNode = function (tree) {
					...
					//Change fontsize here MW 08 Dec 2018                    
